 ...
 */
final class Version20200602231342 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD `order` VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE order_detail ADD CONSTRAINT FK_ED896F46F5299398 FOREIGN KEY (`order`) REFERENCES `order` (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP `order`');
